...
subtest 'default endpoint' => sub {
    ...
    is $api->auth_params, 'client_id=123&client_secret=abc', 'auth_params properly set';
};
...
subtest 'custom endpoint' => sub {
    ...
    is $api->auth_params, 'client_id=def&client_secret=456', 'auth_params properly set';
};
